...
const simplePageRows: Array<[string, string, string, string, string, string, string]> = [
  ['customs-clearance-kenya', 'Customs Clearance Kenya | KRA, KPA & KEBS Import Support', 'Licensed customs clearance in Kenya for import, export and transit cargo with KRA, KPA, KEBS, IDF, duty planning, document review and release support.', '/images/clearing-forwarding-hero-1200.jpg', 'Licensed Kenya customs clearance support', 'Customs clearance in Kenya for importers who need KRA, KPA and KEBS steps handled clearly.', 'Kenya Tradex supports import, export and transit cargo files through document review, duty planning, agency requirement checks and release coordination for cargo moving through Mombasa, Nairobi ICD and JKIA.'],
