  ...
  collections: {
    ...
    blog: defineCollection({
      ...
      schema: z.object({
        ...
        updated: z.string().optional(),
        newsletterVersion: z.number().int().min(0).default(0).editor({ description: 'Increase this number only when this article should appear in the next subscriber digest.' }),
        newsletterSubject: z.string().optional().editor({ description: 'Optional email subject when this is the only article in a digest.' }),
        newsletterSummary: z.string().optional().editor({ input: 'textarea', description: 'Short subscriber-facing summary. The SEO description is used when empty.' }),
        canonical: z.string().optional(),
        route: routeSchema.optional(),
        sitemap: sitemapSchema.optional(),
        nav: navSchema.optional()
